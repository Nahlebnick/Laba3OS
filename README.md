...
- Объкты синхронизации: Критические секции (Critical Section) и события (Event)
...
Main
├── include/
│   ├── event.h             # Класс для работы с событиями
│   ├── inputUtils.h        # Утилита для ввода с консоли
|   ├── thread.h            # Класс для работы с потоками
└── src/
│   ├── Main/       # Основной поток
```
...
1. Откройте файл решения "LabOS3.sln" в Visual Studio.
